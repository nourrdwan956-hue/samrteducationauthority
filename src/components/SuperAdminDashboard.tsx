          ...
          <div className={`relative w-full max-w-2xl rounded-3xl border shadow-2xl p-6 sm:p-8 overflow-hidden text-right my-8 space-y-6 ${
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className={`text-lg font-black flex items-center gap-2 ${isLight ? 'text-slate-900' : 'text-white'}`}>
                    ...
                    <span className="text-xs px-2 py-0.5 rounded-lg bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
                      قيد معتمد وموثق
                    </span>
                  </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <div className={`p-3.5 rounded-2xl border space-y-1 ${
                ...
                <div className="text-[11px] text-emerald-600 dark:text-emerald-400 font-bold">حساب معتمد وموثق رسمياً</div>
              </div>
            ...
            <div className={`p-4 rounded-2xl border text-xs flex items-center justify-between ${
              ...
              <div className="space-y-0.5">
                <div className={`font-bold flex items-center gap-1.5 ${isLight ? 'text-slate-900' : 'text-white'}`}>
                  ...
                  <span>ملف موحد خاضع لسياسة الحساب المفرد</span>
                </div>
                <div className={`text-[11px] ${isLight ? 'text-slate-500' : 'text-slate-400'}`}>
